...
/**
 * Indicates that a type in an array didn't match the schema.
 */
class InvalidTypeArraySchemaException extends InvalidArraySchemaException {

  /**
   * Creates a new InvalidTypeArraySchemaException object.
   *
  ...
  public function __construct(?string $message = NULL, int $code = 0, ?\Throwable $previous = NULL) {
    ...
    parent::__construct(StringHelpers::getValueOrDefault($message, 'The type of one of the array elements didn\'t match the schema.'), $code, $previous);
  }
