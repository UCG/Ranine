...
class StringPartTest extends TestCase {
  ...
  #[CoversFunction('equalsStringPart')]
  ...
  #[CoversFunction('getBackingString')]
  ...
  #[CoversFunction('getStartPosition')]
  ...
  #[CoversFunction('withNewEndpoints')]
